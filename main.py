...
def intro():
    ...
    if a == "1":
       ...
       print 
       os.system('cd && rm -rf N-TRACE && apt update && apt upgrade && pkg install git -y && git clone https://github.com/Nabil-Official/N-TRACE && cd N-TRACE && chmod +x setup.sh && ./setup.sh ')
    elif a == "6":
